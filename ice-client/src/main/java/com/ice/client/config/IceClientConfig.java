...
public class IceClientConfig {
  ...
  public SimpleMessageListenerContainer iceUpdateMessageContainer(
    ...
    /**版本兼容*/
    container.setMessageListener((Object) new IceUpdateListener());
    return container;
  }
  ...
  public SimpleMessageListenerContainer iceShowConfMessageContainer(
    ...
    container.setAcknowledgeMode(AcknowledgeMode.NONE);
    /**版本兼容*/
    container.setMessageListener((Object) new IceShowConfListener(app, iceRabbitTemplate));
    return container;
  }
  ...
  public SimpleMessageListenerContainer iceMockMessageContainer(
    ...
    container.setAcknowledgeMode(AcknowledgeMode.NONE);
    /*版本兼容*/
    container.setMessageListener((Object) iceMockListener());
    return container;
  }
